...
DEplot <- ggplot(DelawareDF, aes(x = year, y = percent)) +
  ...
  labs(y = NULL, x = NULL) +
  annotate("text", x = 6.5, y = 65, family = "Puritan", color = "black", label = "WHITE") + 
  annotate("text", x = 6.5, y = 15, family = "Puritan", color = "black", label = "NEGRO") +
  annotate("text", x = 6.5, y = 115, family = "Puritan", color = "black", label = "DELAWARE") +
  theme(axis.text.x.top = element_text(margin = margin(b = -60, t = 20),
                                       colour = "gray21", 
                                       face = "bold", family = "Puritan", angle = 90),
...
KYplot <- ggplot(KentuckyDF, aes(x = year, y = percent)) +
  ...
  annotate("text", x = 6.5, y = 65, family = "Puritan", color = "black", label = "WHITE") + 
  annotate("text", x = 6.5, y = 15, family = "Puritan", color = "black", label = "NEGRO") +
  annotate("text", x = 6.5, y = 115, family = "Puritan", color = "black", label = "KENTUCKY") +
  theme(axis.text.x.top = element_text(margin = margin(b = -60, t = 20),
                                       colour = "gray21", 
                                       face = "bold", family = "Puritan", angle = 90),
        axis.text.y = element_text(vjust = -0.01,
...
NCplot <- ggplot(NorthCarolinaDF, aes(x = year, y = percent)) +
  ...
  annotate("text", x = 6.5, y = 65, family = "Puritan", color = "black", label = "WHITE") + 
  annotate("text", x = 6.5, y = 15, family = "Puritan", color = "black", label = "NEGRO") +
  annotate("text", x = 6.5, y = 115, family = "Puritan", color = "black", label = "NORTH CAROLINA") +
  theme(axis.text.x.top = element_text(margin = margin(b = -60, t = 20),
                                       colour = "gray21", 
                                       face = "bold", family = "Puritan", angle = 90),
        axis.text.y = element_text(vjust = -0.01,
...
ARplot <- ggplot(ArkansasDF, aes(x = year, y = percent)) +
  ...
  labs(y = NULL, x = NULL) +
  annotate("text", x = 6.5, y = 65, family = "Puritan", color = "black", label = "WHITE") + 
  annotate("text", x = 8.5, y = 15, family = "Puritan", color = "black", label = "NEGRO") +
  annotate("text", x = 6.5, y = 115, family = "Puritan", color = "black", label = "ARKANSAS") +
  theme(axis.text.x.top = element_text(margin = margin(b = -60, t = 20),
                                       colour = "gray21", 
                                       face = "bold", family = "Puritan", angle = 90),
        axis.text.y = element_text(vjust = -0.01,
...
MDplot <- ggplot(MarylandDF, aes(x = year, y = percent)) +
  ...
  annotate("text", x = 6.5, y = 65, family = "Puritan", color = "black", label = "WHITE") + 
  annotate("text", x = 6.5, y = 15, family = "Puritan", color = "black", label = "NEGRO") +
  annotate("text", x = 6.5, y = 115, family = "Puritan", color = "black", label = "MARYLAND") +
  theme(axis.text.x.top = element_text(margin = margin(b = -60, t = 20),
                                       colour = "gray21", 
                                       face = "bold", family = "Puritan", angle = 90),
        axis.text.y = element_text(vjust = -0.01,
...
MOplot <- ggplot(MissouriDF, aes(x = year, y = percent)) +
  ...
  labs(y = NULL, x = NULL) +
  annotate("text", x = 6.5, y = 65, family = "Puritan", color = "black", label = "WHITE") + 
  annotate("text", x = 6.5, y = 7, family = "Puritan", color = "black", label = "NEGRO") +
  annotate("text", x = 6.5, y = 115, family = "Puritan", color = "black", label = "MISSOURI") +
  theme(axis.text.x.top = element_text(margin = margin(b = -60, t = 20),
                                       colour = "gray21", 
                                       face = "bold", family = "Puritan", angle = 90),
        axis.text.y = element_text(vjust = -0.01,
...
SCplot <- ggplot(SouthCarolinaDF, aes(x = year, y = percent)) +
  ...
  geom_segment(x = 1.5, xend = 12.5, y = 100, yend = 100) +
  labs(y = NULL, x = NULL) +
  annotate("text", x = 6.5, y = 67, family = "Puritan", color = "black", label = "WHITE") + 
  annotate("text", x = 6.5, y = 27, family = "Puritan", color = "black", label = "NEGRO") +
  annotate("text", x = 6.5, y = 115, family = "Puritan", color = "black", label = "SOUTH CAROLINA") +
  theme(axis.text.x.top = element_text(margin = margin(b = -60, t = 20),
                                       colour = "gray21", 
                                       face = "bold", family = "Puritan", angle = 90),
        axis.text.y = element_text(vjust = -0.01,
...
MSplot <- ggplot(MississippiDF, aes(x = year, y = percent)) +
  ...
  annotate("text", x = 6.5, y = 67, family = "Puritan", color = "black", label = "WHITE") + 
  annotate("text", x = 6.5, y = 27, family = "Puritan", color = "black", label = "NEGRO") +
  annotate("text", x = 6.5, y = 115, family = "Puritan", color = "black", label = "MISSISSIPPI") +
  theme(axis.text.x.top = element_text(margin = margin(b = -60, t = 20),
                                       colour = "gray21", 
                                       face = "bold", family = "Puritan", angle = 90),
        axis.text.y = element_text(vjust = -0.01,
...
DCplot <- ggplot(DCdf, aes(x = year, y = percent)) +
  ...
  labs(y = NULL, x = NULL) +
  annotate("text", x = 6.5, y = 67, family = "Puritan", color = "black", label = "WHITE") + 
  annotate("text", x = 6.5, y = 17, family = "Puritan", color = "black", label = "NEGRO") +
  annotate("text", x = 6.5, y = 115, family = "Puritan", color = "black", label = "DISTRICT of COLUMBIA") +
  theme(axis.text.x.top = element_text(margin = margin(b = -60, t = 20),
                                       colour = "gray21", 
                                       face = "bold", family = "Puritan", angle = 90),
        axis.text.y = element_text(vjust = -0.01,
...
TNplot <- ggplot(TennesseeDF, aes(x = year, y = percent)) +
  ...
  labs(y = NULL, x = NULL) +
  annotate("text", x = 6.5, y = 67, family = "Puritan", color = "black", label = "WHITE") + 
  annotate("text", x = 7.5, y = 17, family = "Puritan", color = "black", label = "NEGRO") +
  annotate("text", x = 6.5, y = 115, family = "Puritan", color = "black", label = "TENNESSEE") +
  theme(axis.text.x.top = element_text(margin = margin(b = -60, t = 20),
                                       colour = "gray21", 
                                       face = "bold", family = "Puritan", angle = 90),
        axis.text.y = element_text(vjust = -0.01,
...
GAplot <- ggplot(GeorgiaDF, aes(x = year, y = percent)) +
  ...
  annotate("text", x = 6.5, y = 67, family = "Puritan", color = "black", label = "WHITE") + 
  annotate("text", x = 6.5, y = 27, family = "Puritan", color = "black", label = "NEGRO") +
  annotate("text", x = 6.5, y = 115, family = "Puritan", color = "black", label = "GEORGIA") +
  theme(axis.text.x.top = element_text(margin = margin(b = -60, t = 20),
                                       colour = "gray21", 
                                       face = "bold", family = "Puritan", angle = 90),
        axis.text.y = element_text(vjust = -0.01,
...
LAplot <- ggplot(LouisianaDF, aes(x = year, y = percent)) +
  ...
  labs(y = NULL, x = NULL) +
  annotate("text", x = 6.5, y = 67, family = "Puritan", color = "black", label = "WHITE") + 
  annotate("text", x = 6.5, y = 34, family = "Puritan", color = "black", label = "NEGRO") +
  annotate("text", x = 6.5, y = 115, family = "Puritan", color = "black", label = "LOUISIANA") +
  theme(axis.text.x.top = element_text(margin = margin(b = -60, t = 20),
                                       colour = "gray21", 
                                       face = "bold", family = "Puritan", angle = 90),
        axis.text.y = element_text(vjust = -0.01,
...
# Focus on Virginia & West Virginia
...
VAplot <- ggplot(VirginiaDF, aes(x = year, y = percent)) +
  ...
  annotate("text", x = 6.5, y = 65, family = "Puritan", color = "black", label = "WHITE") + 
  annotate("text", x = 6.5, y = 15, family = "Puritan", color = "black", label = "NEGRO") +
  annotate("text", x = 6.5, y = 115, family = "Puritan", color = "black", label = "VIRGINIA & WEST VIRGINIA") +
  theme(axis.text.x.top = element_text(margin = margin(b = -60, t = 20),
                                       colour = "gray21", 
                                       face = "bold", family = "Puritan", angle = 90),
        axis.text.y = element_text(vjust = -0.01,
...
TXplot <- ggplot(TexasDF, aes(x = year, y = percent)) +
  ...
  geom_segment(x = 1.5, xend = 12.5, y = 100, yend = 100) +
  labs(y = NULL, x = NULL) +
  annotate("text", x = 10, y = 65, family = "Puritan", color = "black", label = "WHITE") + 
  annotate("text", x = 10, y = 15, family = "Puritan", color = "black", label = "NEGRO") +
  annotate("text", x = 6.5, y = 115, family = "Puritan", color = "black", label = "TEXAS") +
  theme(axis.text.x.top = element_text(margin = margin(b = -60, t = 20),
                                       colour = "gray21", 
                                       face = "bold", family = "Puritan", angle = 90),
        axis.text.y = element_text(vjust = -0.01,
...
ALplot <- ggplot(AlabamaDF, aes(x = year, y = percent)) +
  ...
  labs(y = NULL, x = NULL) +
  annotate("text", x = 6.5, y = 65, family = "Puritan", color = "black", label = "WHITE") + 
  annotate("text", x = 10, y = 25, family = "Puritan", color = "black", label = "NEGRO") +
  annotate("text", x = 6.5, y = 115, family = "Puritan", color = "black", label = "ALABAMA") +
  theme(axis.text.x.top = element_text(margin = margin(b = -60, t = 20),
                                       colour = "gray21", 
                                       face = "bold", family = "Puritan", angle = 90),
        axis.text.y = element_text(vjust = -0.01,
...
FLplot <- ggplot(FloridaDF, aes(x = year, y = percent)) +
  ...
  labs(y = NULL, x = NULL) +
  annotate("text", x = 6.5, y = 65, family = "Puritan", color = "black", label = "WHITE") + 
  annotate("text", x = 8.5, y = 25, family = "Puritan", color = "black", label = "NEGRO") +
  annotate("text", x = 6.5, y = 115, family = "Puritan", color = "black", label = "FLORIDA") +
  theme(axis.text.x.top = element_text(margin = margin(b = -60, t = 20),
                                       colour = "gray21", 
                                       face = "bold", family = "Puritan", angle = 90),
        axis.text.y = element_text(vjust = -0.01,
